...
class Reactionrole(commands.Cog):
    ...
    @reaction_group.command(name="add", description="Add a reaction role")
    @blacklist_check()
    async def add_reaction_role(self, interaction: discord.Interaction, role: discord.Role, emoji: str):
