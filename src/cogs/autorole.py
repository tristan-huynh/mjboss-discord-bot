...
class Autorole(commands.Cog):
    ...
    @app_commands.command(name="setautorole", description="Set a role to be assigned to new members.")
    ...
    @app_commands.command(name="clearautorole", description="Clear the autorole setting for this server.")
    @app_commands.default_permissions(manage_roles=True)
    @blacklist_check()
